...
截图可以放在 `docs/screenshots/` 目录中。推荐使用下面这些文件名，添加图片后 README 会自动展示。

<p align="center">
  <img src="docs/screenshots/library.png" width="45%" alt="音乐库界面" />
  <img src="docs/screenshots/lyrics.png" width="45%" alt="全屏歌词界面" />
</p>

<p align="center">
  <img src="docs/screenshots/desktop-lyrics.png" width="45%" alt="桌面歌词界面" />
  <img src="docs/screenshots/settings.png" width="45%" alt="设置界面" />
</p>
